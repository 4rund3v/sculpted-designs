...
<div class="container">
    ...
    <h1 class="mt-4 mb-3">House Warming</h1>

    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="index.html">Home</a>
        </li>
        <li class="breadcrumb-item active">House Warming</li>
    </ol>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item active" style="background-image:url('img/houseWarming2.jpg')">
                        <div class="carousel-caption d-none d-md-block">
                            <h3>Decorations </h3>
                        </div>
                    </div>
                    <!-- Slide Two - Set the background image for this slide in the line below -->
                    <div class="carousel-item" style="background-image: url('img/houseWarming.jpg')">
                        <div class="carousel-caption d-none d-md-block">
        ...
        <div class="col-md-4">
            <h3 class="my-3">House Warming</h3>
            <p>House warming ceremony is performed on the occasion of one's first entry into a new house. Holding a housewarming party is the best way to invite your near and dear ones to your new home. Most of us hold a housewarming party to present our new home to all friends and family and take blessings from all your loved ones and this calls for a celebration. It is stressful to organizing a housewarming party of your own as you cannot find enough time to arrange everything because of your busy work schedule.  We try to learn all the details of your ceremony and work based on your ideas.</p>
            <h3 class="my-3">Package Details</h3>
            <ul>
                <li>Flowers &amp; Lightings </li>
                <li>Invitation Cards cake</li>
                <li>Decorations</li>
                <li>Catering</li>
                <li> Priest &amp; accessories</li>
                <li>Occasion photography and vediography</li>
            </ul>
